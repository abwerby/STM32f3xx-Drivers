...
#define GPIOA_BSR                 *((uint32_t*)(GPIOA_Base_Address + 0x18))
...
#define GPIOB_BSR                 *((uint32_t*)(GPIOB_Base_Address + 0x18))
...
#define GPIOC_BSR                 *((uint32_t*)(GPIOC_Base_Address + 0x18))
...
#define GPIOD_BSR                 *((uint32_t*)(GPIOD_Base_Address + 0x18))
...
#define GPIOE_BSR                 *((uint32_t*)(GPIOE_Base_Address + 0x18))
...
#define GPIOF_BSR                 *((uint32_t*)(GPIOF_Base_Address + 0x18))
