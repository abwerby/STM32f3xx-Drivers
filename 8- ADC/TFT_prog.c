...
#define DelayMs(n)  for (uint32_t i = 0; i < 100000; i++);


void PIN_OUTPUT (uint8_t GPIOx, uint16_t GPIO_Pin)
{
...
void TFT_Print_String(int8_t *string , uint8_t TFT_STRING_MODE)
{
	switch(textsize)
	{
...
void TFT_Print_Number(long  Number, uint8_t TFT_STRING_MODE)
{
