...
#define PIN_HIGH(GPIOx, GPIO_Pin)  GPIO_write_to_pin(GPIOx, GPIO_Pin, HIGH);
#define PIN_LOW(GPIOx, GPIO_Pin)   GPIO_write_to_pin(GPIOx, GPIO_Pin, LOW);
...
#define write_8(d) { \
 GPIOA_BSRR = 0b00000011100000000 << 16; \
 GPIOB_BSRR = 0b00000010000111000 << 16; \
 GPIOC_BSRR = 0b00000000010000000 << 16; \
 GPIOA_BSRR = (((d) & (1<<7)) << 1) \
						 | (((d) & (1<<0)) << 9) \
						 | (((d) & (1<<2)) << 8); \
 GPIOB_BSRR = (((d) & (1<<3)) << 0) \
...
void TFT_Print_Char14x24(uint16_t x,uint16_t y,uint8_t data ,uint8_t mode);
void TFT_Print_Char18x32(uint16_t x,uint16_t y,uint8_t data,uint8_t mode);
void TFT_Print_Char8x16(uint16_t x,uint16_t y,uint8_t num,uint8_t mode);
void TFT_Print_String18x32(int8_t *string,uint8_t TFT_STRING_MODE);
void TFT_Print_String14x24(int8_t *string,uint8_t TFT_STRING_MODE);
void TFT_Print_String8x16(int8_t *string,uint8_t TFT_STRING_MODE);
